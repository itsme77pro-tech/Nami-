...
class MessageTemplateLibrary:
    ...
    def session_start_alert(session_name, market_context=None):
        ...
        return f"""
message = f"""
{session_emoji} <b>TRADING SESSION STARTED - {current_session}</b>

<b>Market Environment</b>
- Volatility: {vol_indicator} {volatility}
- Trend Bias: {trend_indicator} {trend}
- Liquidity: {"HIGH" if 'overlap' in session_name.lower() else "NORMAL"}
...
<i>Session started at {datetime.now(pytz.UTC).strftime('%H:%M:%S')} UTC</i>
"""
"""
...
# Assuming these are defined in Part 1/2/3
# from part1 import Signal, Trade, TradeStatus, TradeOutcome, ProbabilityModel, UXSignal, VolatilityRegime
# from part1 import DATA_DIR, WATCHLIST, TELEGRAM_TOKEN, CHAT_ID, TWELVEDATA_KEY
# from part1 import BINANCE_API_KEY, BINANCE_API_SECRET, ALLOWED_TRADING_SESSIONS, MAX_USD_TRADES
# from part1 import ATR_PERIOD, ATR_MULTIPLIER_SL, ATR_MULTIPLIER_TP, MIN_EDGE, MIN_PROBABILITY
# from part1 import PARTIAL_TP_PCT, PERSONALITY, EXCHANGE_MODE, SCAN_INTERVAL, BACKTEST_MODE
# from part2 import EventTriggerEngine, WhaleDetectionEngine, AlertType, RegimeEngine, LiquidityEngine
# from part2 import OrderflowDetector, StrategyOrchestrator, PortfolioRiskManager, ExecutionEngine
# from part3 import HybridExchangeManager, TechnicalCore
